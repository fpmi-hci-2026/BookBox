...
- **Ozon.by** — основной источник: внутренние переходы (ozon.ru), поисковики (Яндекс), соцсети (VK).
...
**Ссылка на опрос:** [BookBox — опрос потенциальных пользователей](https://forms.gle/example)
...
Студентка 3 курса факультета прикладной математики. Живёт в общежитии, подрабатывает репетитором. Не замужем.
...
### 9.2. Ключевой персонаж №2. Дмитрий, 30 лет
...
### 9.4. Дополнительный персонаж. Максим, 23 года
